...
public final class BlazeJavaImportResult
  ...
  public static BlazeJavaImportResult fromProto(ProjectData.BlazeJavaImportResult proto) {
    return builder()
        ...
        .setPluginProcessorJars(
            ProtoWrapper.map(proto.getPluginProcessorJarsList(), BlazeJarLibrary::fromProto))
        .build();
  }
  ...
  public static class Builder {
    ...
    public Builder setPluginProcessorJars(List<BlazeJarLibrary> pluginProcessorJars) {
